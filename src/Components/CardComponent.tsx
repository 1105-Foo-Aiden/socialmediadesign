...
export default function CardComponent() {
   return (
    ...
    <section className="py-10 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
      <article className="bg-slate-200 dark:bg-slate-800 p-5 rounded-sm  dark:shadow-slate-700 border-t-8 border-blue-600 hover:bg-slate-300 dark:hover:bg-slate-700">
      ...
      <article className="bg-slate-200 dark:bg-slate-800 p-5 rounded-sm  dark:shadow-slate-700 border-t-8 border-blue-500 hover:bg-slate-300 dark:hover:bg-slate-700">
        <ul className="flex items-center justify-center text-center mt-3">
          <li>
      ...
      <article className="bg-slate-200 dark:bg-slate-800 p-5 rounded-sm  dark:shadow-slate-700 relative hover:bg-slate-300 dark:hover:bg-slate-700">
        <div className="bg-gradient-to-r from-[#fdc468] to-[#df4996] h-2 w-full rounded-tl-sm rounded-tr-sm absolute top-0 left-0"></div>
        <ul className="flex items-center justify-center text-center mt-3">
          <li>
      ...
      <article className="bg-slate-200 dark:bg-slate-800 p-5 rounded-sm  dark:shadow-slate-700 border-t-8 border-red-700 hover:bg-slate-300 dark:hover:bg-slate-700 border-solid">
        <ul className="flex items-center justify-center text-center mt-3">
          <li>

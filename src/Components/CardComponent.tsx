    ...
    <section className="py-10 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
      <article className="bg-slate-200 p-5 rounded-lg shadow shadow-slate-50">
        ...
        <h2 className="text-5xl font-bold text-slate-800 text-center my-5">
          1987 <span className="text-sm block text-slate-600 font-normal uppercase tracking-widest">Followers</span>
        </h2>
      ...
      <article className="bg-slate-200 p-5 rounded-lg shadow shadow-slate-50">
        ...
        <h2 className="text-5xl font-bold text-slate-800 text-center my-5">
          1044 <span className="text-sm block text-slate-600 font-normal uppercase tracking-widest">Followers</span>
        </h2>
        <p className="text-center text-emerald-600 flex items-center justify-center font-bold">
      ...
      <article className="bg-slate-200 p-5 rounded-lg shadow shadow-slate-50">
        ...
        <h2 className="text-5xl font-bold text-slate-800 text-center my-5">
          11k <span className="text-sm block text-slate-600 font-normal uppercase tracking-widest">Followers</span>
        </h2>
      ...
      <article className="bg-slate-200 p-5 rounded-lg shadow shadow-slate-50">
        ...
        <h2 className="text-5xl font-bold text-slate-800 text-center my-5">
          8329 <span className="text-sm block text-slate-600 font-normal uppercase tracking-widest">Subscribers</span>
        </h2>

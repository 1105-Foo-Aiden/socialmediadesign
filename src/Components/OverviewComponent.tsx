...
export default function OverviewComponent() {
  return (
    <>
      <h2 className="text-slate-600 font-bold mb-8 text-2xl md:text-3xl">Overeview - Today</h2>
      <section className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
        <article className="bg-slate-200 p-5 rounded shadow shadow-slate-50">
            <ul className="flex items-center justify-between mb-5">
                <li className="text-slate-600">Page Views</li>
        ...
        <article className="bg-slate-200 p-5 rounded shadow shadow-slate-50">
            <ul className="flex items-center justify-between mb-5">
                <li className="text-slate-600">Likes</li>
                <li><img src={facebook} alt="Facebook" /></li>
            </ul>
            <ul className="flex items-center justify-between">
        ...
        <article className="bg-slate-200 p-5 rounded shadow shadow-slate-50">
            <ul className="flex items-center justify-between mb-5">
                <li className="text-slate-600">Profile Views</li>
                <li><img src={instagram} alt="Facebook" /></li>
            </ul>
            <ul className="flex items-center justify-between">
        ...
        <article className="bg-slate-200 p-5 rounded shadow shadow-slate-50">
            <ul className="flex items-center justify-between mb-5">
                <li className="text-slate-600">Retweets</li>
        ...
        <article className="bg-slate-200 p-5 rounded shadow shadow-slate-50">
            <ul className="flex items-center justify-between mb-5">
                <li className="text-slate-600">Total Views</li>
                <li><img src={youtube} alt="youtube" /></li>
            </ul>
            <ul className="flex items-center justify-between">
